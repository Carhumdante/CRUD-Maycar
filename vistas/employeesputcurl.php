...
curl_setopt_array($curl, array(
    CURLOPT_URL => 'W611NQ2IFH8BQUY9UN9DL8WW5MVBEV5L@localhost/prestashop/api/employees/'.$id.'?output_format=JSON',
            ...
            <div class="table-wrapper">
                ...
                <form action="./vistas/employeespostcurl.php" method="POST" id="myform">
                    ...
                    <P>
                        ...
                        <INPUT type="text" name="nombre" value = <? echo $firstname; ?>><BR>
                        <LABEL for="apellido">Apellido: </LABEL>
                        <INPUT type="text" name="apellido" value = <? echo $lastname; ?>><BR>
                        <LABEL for="email">Email: </LABEL>
                        <INPUT type="text" name="email" value = <? echo $email; ?>><BR>
                        <LABEL for="passwd">Password: </LABEL>
                        <INPUT type="pass" name="passwd" value = <? echo $passwd; ?>><BR>
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'W611NQ2IFH8BQUY9UN9DL8WW5MVBEV5L@localhost/prestashop/api/employees/2',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
