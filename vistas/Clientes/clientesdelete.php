        ...
        <div class="table-responsive">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-12">
                            <h2> <b>Clientes DELETE</b></h2>
                        </div>
                    </div>
                </div>
                <form action="./cURL/Clientes/clientesdeletecurl.php" method="POST">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Elija el ID del Cliente a Eliminar</label>
